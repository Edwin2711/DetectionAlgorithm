...
class ConvNet(nn.Module):
    def __init__(self,num_classes=2):
        ...
        self.fc=nn.Linear(in_features= 200 * 150 * 32,out_features=num_classes)
    ...
    def forward(self,input):
        ...
        output=output.view(-1,32*200*150)
            
            
        output=self.fc(output)   
        return output

checkpoint=torch.load("C:\\Users\\Edwin\\Desktop\\FullCode\\best_checkpoint93.model",map_location=torch.device('cpu'))
...
def main():
    ...
    #STEP 1:
    referenceImage = cv2.imread("C:\\Users\\Edwin\\Desktop\\FullCode\\reference.jpg")
